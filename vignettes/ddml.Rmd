...
get_ddml_samples <- function(dp, 
                                 sample_folds = 3, cv_folds = 2,
                                   subsamples_byG = NULL) {
  ...
  cluster_variable <- dp$data[, idname]
...
usr_pre <- get_crossfit_samples(dp, sample_folds = 3, cv_folds = 2,
                                   subsamples_byD = NULL,
...
ddml_did_method <- function(y1, y0, D, covariates, usr_pre, ...) {
  # Construct subsamples from 
